			...
			<table class="table table-responsive">
				<thead>
					<tr>
						...
						<td class="text-center hidden-xs hidden-sm"><span style="font-weight: bold;">Tipo de Pessoa</span></td>
						...
						<td class="text-center hidden-xs hidden-sm"><span style="font-weight: bold;">Responsável</span></td>
