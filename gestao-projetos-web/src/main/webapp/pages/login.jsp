...
<body>
		...
		<div class="container">
			...
			<form action="/gestao-projetos/autenticar" method="POST" role="form">
				<div class="row" style="padding-top: 20px">
					<div
						class="form-group col-md-4 col-md-offset-4 col-xs-8 col-xs-offset-2">
				...
				<div class="row">
					<div class="text-center">
						...
						<button type="submit" class="btn btn-default"
							style="background-color: #4DC1FF; color: #fff; border-color: #4DC1FF">Acessar
							o sistema</button>
						<br /> <br> <a href="esqueceu-senha">Esqueci minha senha</a>
					</div>
				</div>
			</form>
		</div>
	...
	<footer>
		<div
			...
			style="background-color: #4DC1FF; color: #fff; padding: 20px; margin-top: 68px; position: relative;">
